...
public class UserController {
	...
	@RequestMapping(value="/changepassword")
	 public ModelAndView changepassword(String loginname,
			 String rewpassword,String rewpsd,
			ModelAndView mv,
			HttpSession session){
		userService.changepassword(loginname,rewpassword,rewpsd);
	...
	@RequestMapping(value="/forgetpwd1")
	 public ModelAndView find(String loginname,String email,ModelAndView mv,HttpSession session,HttpServletResponse response) throws Exception{		
		...
		if(user!=null){
			...
			sendemail.setAuthentication("m18252104723_1@163.com","lby111");
			sendemail.setCharset("UTF-8");
			
			try{
				sendemail.setCharset("UTF-8");
				sendemail.addTo(email);
				sendemail.setFrom("m18252104723_1@163.com");
